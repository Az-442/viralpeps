...
def build():
    ...
    render_content(pdf, [
        ...
        ("spacer", 1),
        ("bullet", "Verified business identity signal (+10 to +25 points)"),
    ...
    pdf.add_page()
    roadmap = [
        ("Independent review app", "Help your customers collect genuine, independent reviews."),
        ...
        ("Marketing services", "Hands-on help growing your store's reach."),
        ("Business consultations", "Direct guidance on running a trusted supplement business."),
        ("Influencer programs", "Connections to relevant creators - paid and product-based."),
        ("Web development services", "Build or improve your storefront."),
        ("Payment processing services", "Better, verified ways for your buyers to pay."),
    ]
    blocks = [
    ...
    blocks.append(("cta", "Early adopters get first access to every new tool.", PURPLE, 16))
