# Buffer API Configuration — ViralPeps
...
## Usage
- Scheduling posts via GraphQL mutations
- Post times: TikTok 7pm, IG 6pm, X 9am/1pm/6pm
- Platform-specific adaptations handled per post
