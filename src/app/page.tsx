...
export default function Home() {
 ...
 <section className="py-10 max-w-[76rem] mx-auto px-4 bg-blue-50">
   <div className="mb-5">
 ...
 {/* 4. TOP SUPPLIERS */}
 <section className="py-10 max-w-[76rem] mx-auto px-4 bg-indigo-100">
 <div className="mb-5">
 <div className="inline-flex items-center gap-1.5 bg-gray-800 border border-gray-700 rounded-full px-2.5 py-0.5 mb-2">
...
<section className="py-16 md:py-20 max-w-[76rem] mx-auto px-4 text-center bg-white">
 ...
 <p className="text-base md:text-lg text-black leading-relaxed max-w-[76rem] mx-auto">
 ...
 return (
 <section key={group.badge} className={`py-10 max-w-[76rem] mx-auto px-4 ${bgColors[i % 3]}`}>
   <div className="mb-5">
     <div className="inline-flex items-center gap-1.5 bg-gray-800 border border-gray-700 rounded-full px-2.5 py-0.5 mb-2">
...
<section className="py-16 md:py-20 max-w-[76rem] mx-auto px-4 bg-indigo-100">
  <div className="max-w-[76rem] mx-auto">
...
<section className="py-16 md:py-20 max-w-[76rem] mx-auto px-4 bg-white text-center">
 <div className="max-w-[76rem] mx-auto">
 <div className="inline-flex items-center gap-1.5 bg-gray-800 border border-gray-700 rounded-full px-3 py-1 mb-5">
 <svg width="14" height="14" viewBox="0 0 24 24" fill="#3b82f6"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>
...
<section className="py-16 md:py-20 max-w-[76rem] mx-auto px-4 bg-blue-50">
  <div className="max-w-[76rem] mx-auto text-center mb-12">
...
{/* FAQ SECTION */}
<section className="py-16 md:py-20 max-w-[76rem] mx-auto px-4 bg-white">
  <div className="max-w-[76rem] mx-auto">
