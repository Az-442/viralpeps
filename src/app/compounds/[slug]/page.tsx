      ...
      <section className="bg-gradient-to-br from-[#0b1a2e] via-[#162d50] to-[#0f1f38] text-white">
        <div className="max-w-6xl mx-auto px-4 py-10 md:py-16 lg:py-20">
          ...
          <div className="md:flex md:flex-col md:bg-blue-900/20 md:rounded-2xl md:border md:border-blue-400/20 md:p-6 md:mt-3">
            ...
            {/* CTA button */}
            <div className="ml-auto md:ml-0 md:flex md:justify-center md:mt-3">
              <a href="#pricing-table" className="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-600/90 hover:bg-blue-500 text-white text-xs font-semibold rounded-lg transition-colors shadow-sm">
                See all prices
