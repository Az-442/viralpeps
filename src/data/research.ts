...
{
  title: 'KPV Suppliers UK: How to Verify a Vendor Before You Buy',
  desc: 'A supplier guide to KPV in the UK - how the tripeptide supply market is structured, the three vendor types and what each actually documents, and a five-step verification checklist covering batch-matched certificates of analysis, named testing laboratories, company identity, research-use labelling and price-per-milligram comparison. Plus why KPV spread is wider than its cost of goods justifies.',
  category: 'Articles',
  section: 'research-hub',
  compound: 'KPV',
  slug: 'kpv-suppliers-uk',
  image: 'kpv-suppliers-uk',
  minutes: 11,
  tags: ['kpv', 'suppliers', 'uk', 'verify', 'certificate-of-analysis', 'tripeptide', 'research-hub'],
},
{
  title: 'Retatrutide vs Survodutide: Triple Agonist vs Dual Agonist Compared',
  desc: 'A head-to-head on the two leading glucagon-containing incretin agonists - retatrutide (GIP + GLP-1 + glucagon, LY3437943) against survodutide (GLP-1 + glucagon, BI 456906). Shared glucagon mechanism, the GIP arm retatrutide adds, Phase 2 and Phase 3 evidence, tolerability caveats, and why cross-trial weight-loss figures should not be compared directly. Plus the very different UK research-supply pictures.',
  category: 'Articles',
  section: 'comparisons',
  compound: 'Retatrutide',
  slug: 'retatrutide-vs-survodutide',
  image: 'retatrutide-vs-survodutide',
  minutes: 12,
  tags: ['retatrutide', 'survodutide', 'comparison', 'glp-1', 'gip', 'glucagon', 'triple-agonist', 'dual-agonist', 'incretin'],
},
{
  title: 'P21 Deep Dive: The CNTF-Derived CDK5 Inhibitor for Neuroprotection Research',
  desc: 'A full deep dive on P21 (P021), the small D-amino-acid peptide derived from ciliary neurotrophic factor that selectively interrupts the pathological p25-CDK5 complex. Mechanism of CDK5 inhibition, the CNTF connection and why the fragment approach works, key preclinical findings in Alzheimer\'s and traumatic brain injury models, intranasal delivery, the honest limitations of a small literature, and the realities of thin UK research supply.',
  category: 'Articles',
  section: 'peptides',
  compound: 'P21',
  slug: 'p21-deep-dive',
  ...
  {
    title: "Buy Follistatin 344 UK: Reading the Specification, Not the Price",
    desc: "A UK buyer's guide to follistatin-344 — what a 344-amino-acid recombinant glycoprotein actually requires on its certificate of analysis, why the market spread runs six-fold, and how to compare listings that are not directly comparable.",
    category: "Guide",
    section: "research-hub",
    compound: "Follistatin 344",
    slug: "buy-follistatin-344-uk",
    image: "buy-follistatin-344-uk",
    minutes: 11,
    tags: ["follistatin", "follistatin-344", "buying-guide", "myostatin", "recombinant-protein", "coa", "uk-suppliers"],
  },
  {
    title: "Tirzepatide Suppliers UK: How to Compare 30 Vendors",
    desc: "Tirzepatide is the most heavily stocked research peptide in the UK — 30 vendors, 69 listings, and prices from £24.99 to £345.00. How the supply base is structured, how to spot an unmaintained listing, and how to verify a vendor.",
    category: "Guide",
    section: "research-hub",
    compound: "Tirzepatide",
    slug: "tirzepatide-suppliers-uk",
    image: "tirzepatide-suppliers-uk",
    minutes: 12,
    tags: ["tirzepatide", "suppliers", "uk", "glp-1", "gip", "price-per-mg", "buying-guide"],
  },
  {
    title: "TB-500 vs GHK-Cu: Actin Regulation vs Copper Signalling",
    desc: "Two repair peptides with almost nothing in common. TB-500 sequesters actin and drives cell migration within hours; GHK-Cu delivers copper and shifts gene expression over days. Mechanism, evidence base, UK supply and which to choose.",
    category: "Articles",
    section: "comparisons",
    compound: "TB-500",
    slug: "tb-500-vs-ghk-cu",
    image: "tb-500-vs-ghk-cu",
    minutes: 12,
