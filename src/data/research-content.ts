        ...
        subsections: [
          {
            ...
            body: "The SURPASS programme (SURPASS-1 through -5) demonstrated HbA1c reductions of 1.9–2.4% across all doses — the largest ever reported for a glucose-lowering agent. In SURPASS-2, tirzepatide 10 mg and 15 mg were superior to semaglutide 1 mg for both HbA1c reduction (−2.30% vs −1.86%) and weight loss (−11.2 kg vs −5.7 kg). In SURPASS-4, tirzepatide was superior to insulin glargine in patients with established cardiovascular disease.",
          },
          {
          ...
          },
          {
            ...
            body: "The SYNERGY-NASH phase 2 trial (NEJM 2024) demonstrated that tirzepatide achieved MASH resolution without worsening fibrosis in 43.6% (5 mg), 55.5% (10 mg), and 62.4% (15 mg) of patients versus 9.8% with placebo at 52 weeks — a treatment effect 5–6 times greater than placebo. Fibrosis improvement of ≥1 stage was achieved in 51–54% of tirzepatide-treated patients versus 31% with placebo.",
          },
          {
            title: "SUMMIT (Heart Failure / HFpEF)",
            body: "The SUMMIT trial (NEJM 2024) randomly assigned 731 patients with obesity and heart failure with preserved ejection fraction (HFpEF) to tirzepatide or placebo. Tirzepatide reduced the composite endpoint of cardiovascular death or worsening heart failure events (HR 0.62, 95% CI 0.41–0.95) and improved Kansas City Cardiomyopathy Questionnaire scores by 19.5 vs 12.7 points. Hospitalisation for heart failure was reduced by 44%.",
          },
        ],
      },
      {
        title: "Research Applications Beyond the Labels",
        body: "Tirzepatide is being actively investigated across multiple metabolic indications beyond its approved uses.",
        subsections: [
          {
            title: "Cardiovascular Outcomes",
            body: "SURPASS-CVOT, a dedicated cardiovascular outcomes trial enrolling over 12,000 patients, is ongoing with expected readout between 2026 and 2027. Earlier exploratory analyses showed significant reductions in systolic blood pressure (5–8 mmHg), triglycerides (20–35%), and hs-CRP (30–45%).",
          },
          {
          ...
          {
            title: "Kidney, Joint, and Liver Health",
