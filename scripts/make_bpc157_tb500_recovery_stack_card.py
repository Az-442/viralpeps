"""Create the BPC-157 + TB-500 (recovery-stack) guide card.
Two-vial goal-stack layout matching make_sermorelin_ipamorelin_stack_card.py."""
...
VIAL_A = "public/images/compounds/bpc-157-vial.png"
VIAL_B = "public/images/compounds/tb-500-vial.png"
OUTPUT = "public/images/guides/bpc157-tb500-recovery-stack.png"
DESC = [
    "The goal-stack for tissue recovery: a",
    "gut peptide coordinating angiogenesis and",
    "organised collagen with a thymosin beta-4",
    "fragment driving actin-mediated cell",
    "migration, through complementary repair",
    "pathways.",
]
...
# Subtitle
draw.text((text_x, badge_y + 110), "Recovery Stack", fill=BLUE, font=subtitle_font)
