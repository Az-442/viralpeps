"""Create the Tesamorelin + Ipamorelin (fat-loss stack) goal-stack guide card.
Two-vial layout matching the proven make_sermorelin_ipamorelin_stack_card.py."""
...
VIAL_A = "public/images/compounds/tesamorelin-vial.png"
VIAL_B = "public/images/compounds/ipamorelin-vial.png"
OUTPUT = "public/images/guides/tesamorelin-ipamorelin-fat-loss-stack.png"
DESC = [
    "The goal-stack for visceral fat: an",
    "FDA-approved GHRH analog proven to shrink",
    "belly fat and a clean selective ghrelin-",
    "receptor secretagogue reinforcing the same",
    "GH/IGF-1 lipolytic axis.",
]
...
_a2 = _a.resize((_aw, vial_h), Image.LANCZOS)
center_y = int((card_h - vial_h) / 2)
card.paste(_a2, (40, center_y), _a2)

_b = open_vial(VIAL_B)
_bw = int(vial_h * _b.width / _b.height)
_b2 = _b.resize((_bw, vial_h), Image.LANCZOS)
card.paste(_b2, (40 + _aw + gap, center_y), _b2)
text_x = 40 + _aw + gap + _bw + 30
...
# Subtitle
draw.text((text_x, badge_y + 110), "Fat Loss Stack", fill=BLUE, font=subtitle_font)
